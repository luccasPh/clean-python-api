...
from app.data.protocols.repositories.survey.load_survey_result_repo import (
...
from app.data.usecases.survey.db_load_survey_result import DbLoadSurveyResult
